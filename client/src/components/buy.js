...
export const BuyStock = () => {
    ...
    const handleConfirmBuy =async () => {
        ...
        const data1 = await fetch('http://localhost:8000/buy', {
            method: "POST",
            headers: {
                "content-type": "application/json"
            },
        ...
        if(res1.status === 201){
           alert(`Stock ${name} of quantity ${quantity} is successfully buyed`);
        ...
        alert(`Can't buy the stock ${name} due to limited amount`);
     }
    };
